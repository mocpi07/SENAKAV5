...
let memek = { key: { remoteJid: 'status@broadcast', participant: '0@s.whatsapp.net' }, message: { orderMessage: { itemCount: 9999999999, status: 1, thumbnail: await conn.resize(await getBuffer(thumb),300,150), surface: 1, message: 'sᴇɴᴀᴋᴀ ᴀɪ', orderTitle: wm, sellerJid: '0@s.whatsapp.net' } } }
...
`.trimStart(),
  ...
  footer: '╰─── –',
  after: `sᴇɴᴀᴋᴀ ᴀɪ ${global.version}`,
}
  try {
    ...
    let bjir = 'https://files.catbox.moe/i6slhi.jpeg'
 ...
 type: 'audioMessage',  
 ptt: true, contextInfo: { forwardingScore: 999, isForwarded: false, externalAdReply: {title: 'sᴇɴᴀᴋᴀ ᴀɪ', body: wm, sourceUrl: 'https://chat.whatsapp.com/ET0OqBu8wKhJhcjePP9WuE', thumbnail: await (await fetch(bjir)).buffer(),}}  
  }) 
    } catch (e) {
